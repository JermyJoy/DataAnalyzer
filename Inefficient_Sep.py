...
def main():
    ...
    clean_length = clean_vals(length_of_movie)
    clean_release = clean_vals(release_date)
    ...
    clean_INITbudget = clean_vals(budget)
    clean_box = clean_vals(Box_office)

    clean_date(release_date)

    min_remove(length_of_movie)

    clean_budget(Box_office)
    clean_budget(budget)

    '''for index in clean_meta:
        print index'''
