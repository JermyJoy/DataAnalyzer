...
def main():
        ...
        avg_seasons = []
        season_divison = 12/4
        avg_seasons.append((avg_months[5]+avg_months[6]+avg_months[7]) / season_divison) # Summer
        avg_seasons.append((avg_months[8]+avg_months[9]+avg_months[10]) / season_divison) # Fall
        avg_seasons.append((avg_months[2]+avg_months[3]+avg_months[4]) / season_divison) # Spring
        avg_seasons.append((avg_months[0]+avg_months[1]+avg_months[11]) / season_divison) # Winter
        avg_seasons.append((avg_months[5]+avg_months[6]+avg_months[7]) / season_divison) # Summer
        ...
        avg_budget = [np.mean(budget_lowest_rating),np.mean(budget_lower_rating),np.mean(budget_mid_rating),np.mean(budget_higher_rating),np.mean(budget_highest_rating)]
        #####################################################################
        plt.figure(4)
        plt.clf
